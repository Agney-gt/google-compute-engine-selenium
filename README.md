...
```
wget https://raw.githubusercontent.com/Agney-gt/google-compute-engine-selenium/master/install.sh && chmod +x install.sh && ./install.sh &&  ./start_headless.sh && ./demo.py
```
